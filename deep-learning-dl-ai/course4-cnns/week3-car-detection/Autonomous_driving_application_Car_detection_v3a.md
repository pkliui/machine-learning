...
    """
    ...
    inter_width = np.maximum(xi2 - xi1,0) # np.maximum(xi2 - xi1,0) is quivalent to xi2 - xi1 > 0 , i.e. we use non-negative values oly
...
def yolo_eval(yolo_outputs, image_shape = (720., 1280.), max_boxes=10, score_threshold=.6, iou_threshold=.5):
    ...
    scores, boxes, classes = yolo_non_max_suppression(scores, boxes, classes, max_boxes, score_threshold)
