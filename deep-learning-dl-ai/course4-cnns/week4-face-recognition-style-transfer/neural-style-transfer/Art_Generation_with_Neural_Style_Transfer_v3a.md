...
![png](Art_Generation_with_Neural_Style_Transfer_v3a_files/Art_Generation_with_Neural_Style_Transfer_v3a_8_0.png)
...
def compute_content_cost(a_C, a_G):
    ...
    J_content = tf.reduce_sum(1/(4*n_H*n_W*n_C) * tf.square(tf.subtract(a_C_unrolled, a_G_unrolled)))
    ### END CODE HERE ###
...
![png](Art_Generation_with_Neural_Style_Transfer_v3a_files/Art_Generation_with_Neural_Style_Transfer_v3a_16_0.png)
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = tf.reduce_sum(1/(4*(n_H* n_W*n_C)**2) * tf.square(tf.subtract(GS, GG)))
...
![png](Art_Generation_with_Neural_Style_Transfer_v3a_files/Art_Generation_with_Neural_Style_Transfer_v3a_51_0.png)
